...
if /i "!L!"=="FR" set "BSUB=Moins de lag, plus de r�activit�"
cls
echo  !CM!================================================================!C0!
...
goto _strdone
:_strfr
set "M0=!CW!CPU/RAM!C0! : svchost regroup�, quantum premier plan, SysMain on"
set "M2=!CW!MMCSS!C0! profil Games : priorit� GPU et CPU !CG!maximale!C0!"
set "M3L=Priorit� CPU et E/S �lev�e sur !CW!CS2, LoL, Brawlhalla, R6, Valorant, Apex, Fortnite!C0!"
set "M3S=Priorit� CPU/E-S par jeu : !CG!d�faut (soft)!C0!"
set "M4=GPU !CW!NVIDIA!C0! : ancienne m�thode de sharpening !CG!restaur�e!C0!, mode MSI !CG!activ�!C0!"
set "M5=GPU !CW!AMD!C0! : ULPS !CR!off!C0!, mode MSI !CG!on!C0!"
set "MDLOCK=AMD 25.9.1 -> MAJ pilote GPU !CR!bloqu�es!C0! (Windows Update)"
set "MDFREE=MAJ pilote GPU !CG!laiss�es d�bloqu�es!C0!"
set "M6=Souris !CG!1:1!C0! (acc�l�ration !CR!off!C0!), clavier rapide, touches r�manentes !CR!off!C0!, Impr �cran ouvre !CW!Capture!C0!"
set "M7=!CW!R�seau!C0! : RSC !CR!off!C0!, RSS !CG!on!C0!, �conomie et mod�ration carte r�seau !CR!off!C0!"
set "M8=Timers de d�marrage r�gl�s, noms courts 8.3 NTFS !CR!off!C0!"
set "M9=T�l�m�trie, publicit�, !CW!Recall, Widgets!C0! !CR!off!C0!"
set "M10=!CW!Liste de blocage pub et t�l�m�trie!C0! : !CC!215 domaines!C0! via hosts"
set "M11=T�ches planifi�es de t�l�m�trie !CR!d�sactiv�es!C0!"
set "M12=Services inutiles !CR!d�sactiv�s!C0! (!CW!anticheats!C0! et pilotes intacts)"
set "M13=Indexation Windows !CG!activ�e!C0! (recherche de fichiers)"
set "M14=Plein �cran exclusif !CG!forc�!C0!, GPU hautes performances sur les !CC!7!C0! jeux"
set "M15=!CW!GameDVR!C0! !CR!off!C0!, !CW!Mode Jeu!C0! !CG!on!C0!, optimisations jeux fen�tr�s !CG!on!C0!"
set "M16=!CW!Defender!C0! : jeux !CG!exclus!C0!, analyse planifi�e !CR!off!C0!, analyses brid�es"
set "M16RT=!CW!Temps r�el + comportement + IOAV + cloud + �chantillons!C0! !CR!OFF!C0! (Tamper Protection �tait off)"
set "M16NT=!CW!Protection temps r�el ON!C0! (off seulement en LOWEST + Tamper Protection off)"
set "M17=Debloat !CG!effectu�!C0! (!CW!Store, S�curit�, Capture, Calculatrice, Paint, Spotify!C0! gard�s)"
set "M19=!CW!Outlook!C0! (nouveau) !CR!retir�!C0!"
set "M20=!CW!Confidentialit�!C0! : acc�s applis !CR!off!C0! sauf !CG!microphone!C0! ; applis en arri�re-plan !CR!off!C0!"
set "M72=!CW!Infos de saisie!C0! + !CW!suggestions!C0! + spotlight/voix/presse-papier !CR!OFF!C0!"
set "M73=!CW!MSI mode!C0! sur le GPU (interruptions signal�es) : !CG!ON!C0! (au reboot)"
set "M74=Historique presse-papier, bouton Chat, r�cents Explorateur, Cortana, sons, verrouillage/veille !CR!OFF!C0!"
set "M75=!CW!nag OOBE!C0!, red�marrage auto MAJ, feedback, r�veil maintenance, animation 1re connexion !CR!OFF!C0!"
set "M21=!CW!Cam�ra!C0! !CG!gard�e active!C0! (applis autoris�es)"
set "M22=!CW!Cam�ra!C0! !CR!d�sactiv�e!C0! (p�riph�rique et acc�s applis off)"
set "M23=!CW!Cam�ra!C0! !CG!restaur�e!C0! (p�riph�rique r�activ�)"
set "M24=!CW!Wi-Fi + Ethernet!C0! : inchang�"
set "M25=!CW!Wi-Fi!C0! !CR!d�sactiv�!C0! (service et adaptateurs)"
set "M26=!CW!Wi-Fi!C0! !CG!restaur�!C0! (service et adaptateurs)"
set "M25E=!CW!Ethernet!C0! !CR!d�sactiv�!C0! (adaptateur)"
set "M26E=!CW!Ethernet!C0! !CG!restaur�!C0! (adaptateur)"
set "M27=!CW!Bluetooth!C0! : inchang�"
set "M28=!CW!Bluetooth!C0! !CR!d�sactiv�!C0! (services et radios)"
set "M29=!CW!Bluetooth!C0! !CG!restaur�!C0! (services et radios)"
set "M30=!CW!Imprimante!C0! : inchang�e"
set "M31=!CW!Imprimante!C0! !CR!d�sactiv�e!C0! (spouleur off)"
set "M32=!CW!Imprimante!C0! !CG!restaur�e!C0! (spouleur on)"
set "M33=!CW!Xbox!C0! : inchang�"
set "M34=!CW!Xbox!C0! !CR!supprim�!C0! (apps, services, t�che)"
set "M35=!CW!Xbox!C0! !CG!restaur�!C0! (services en manuel)"
set "M36=!CW!OneDrive!C0! !CR!d�sinstall�!C0!"
set "M40=!CW!Apparence!C0! : transparence, accent gris, fond noir, !CW!th�me sombre!C0!"
set "M43=Barre des t�ches �pur�e (recherche masqu�e, combin�e, !CW!Widgets!C0! !CR!off!C0!, !CW!Task View!C0! !CR!off!C0!, Terminer la t�che !CG!on!C0!)"
set "M44=!CW!Menu D�marrer!C0! : pas de reco, pas d'applis r�centes, notifs !CR!off!C0!"
set "M45=!CW!Explorateur!C0! : �l�ments masqu�s visibles, extensions !CG!on!C0!, ouvre sur !CW!Ce PC!C0!"
set "M46=!CW!Avertissements de s�curit�!C0! !CR!off!C0!"
set "M47=Ancrage et multit�che !CG!on!C0!, Aero Shake !CR!off!C0!"
set "M48=!CW!UAC!C0! : !CY!ne pr�vient jamais!C0! (�l�vation silencieuse)"
set "M49=Bureau � distance et Assistance � distance !CR!off!C0!"
set "M50=Int�grit� m�moire (core isolation) !CG!gard�e on!C0! - requise par certains !CW!anticheats!C0!"
set "M50NOAC=Int�grit� m�moire + VBS + hyperviseur !CR!OFF!C0! (sans anticheat, perf max)"
set "M51=!CW!D�marrage!C0! : pas d'interface, OS non affich�, d�lai !CC!0 seconde!C0!"
set "M52=P�riph�riques fant�mes (d�branch�s) !CR!supprim�s!C0!"
set "M53=!CW!Extras!C0! : FTH !CR!off!C0!, d�lai de d�marrage des applis !CC!0!C0!, arr�t acc�l�r�"
...
set "M54S=!CW!Performances �lev�es!C0! : USB suspend !CR!off!C0!, ASPM !CR!off!C0! ; parking/C-states selon le CPU"
set "M55=!CW!HAGS!C0! support� : !CG!activ�!C0! (effet au red�marrage)"
set "M56=!CW!HAGS!C0! non expos� par la plateforme : !CY!non activ�!C0!"
set "M57=!CW!D�marrage rapide!C0! !CG!activ�!C0!"
set "M58=!CW!Ic�nes au d�marrage masqu�es!C0! : !CW!Vanguard + Defender!C0! (services actifs)"
set "M59=Pilotes maintenus !CG!� jour!C0! via Windows Update"
set "M60=!CW!Optimisation des disques!C0! : t�che !CW!Windows!C0! native !CG!on!C0! (silencieuse, quotidienne)"
set "M61=!CW!Assistant de stockage!C0! !CG!on!C0! : temp + corbeille 1j + t�l�chargements 1j, chaque jour"
set "M62=!CW!Nettoyage!C0! : temp, cache !CW!Discord/Steam!C0!, WinSxS, Windows.old, corbeille"
set "M63=!CW!Windows Update!C0! !CY!en cours!C0! (y compris les !CW!facultatives!C0!)... peut �tre long, ne ferme pas"
set "M64=!CW!Windows Update!C0! !CG!termin�!C0!"
set "M66=Mise � jour des applis via !CW!winget!C0!... peut �tre long"
set "M67=!CW!winget!C0! !CG!termin�!C0!"
set "M69=Timer Windows forc� � !CC!0.5 ms!C0! au d�marrage (aucun outil externe)"
set "M69NG=!CR!T�che timer NON enregistr�e!C0! - relance en admin, puis reboot"
set "M71=R�glages r�-appliqu�s !CG!seulement apr�s une MAJ Windows!C0! ; nettoyage s�r temp + DNS !CG!� chaque session!C0!"
set "R0=Restaur� : !CW!noyau CPU/RAM!C0! par d�faut"
set "R1=Restaur� : !CW!r�seau!C0! par d�faut"
set "R2=Restaur� : !CW!priorit�s par jeu et plein �cran!C0! par d�faut"
set "R3=Restaur� : !CW!GameDVR et aff�tage NVIDIA!C0! par d�faut"
set "R4=Restaur� : !CW!timers, d�marrage et NTFS!C0! par d�faut"
set "R5=Restaur� : !CW!services!C0! par d�faut"
set "R6=Restaur� : !CW!UAC, distance, SmartScreen, alimentation, t�l�m�trie!C0! ; blocage !CW!AMD!C0! retir�"
set "R7=Restaur� : !CW!t�ches personnalis�es!C0! retir�es"
set "MODE_HEAD=MODE"
set "MODE_1=!CO!Appliquer!C0! les optimisations"
set "DESC1=R�duit la latence et le lag d'entr�e pour le jeu."
set "DESC2=Compatible anticheat. Enti�rement r�versible (Restaurer)."
set "MODE_2=!CG!Restaurer!C0! les valeurs par d�faut Windows"
...
set "QAC_NO_DESC=Coupe VBS / HVCI / hyperviseur OFF - plus de perf, s�curit� r�duite"
...
set "QMODE_S_DESC=Gros gain de latence, toutes les protections restent actives. S�r si tu h�sites."
set "QMODE_L_NAME=LATENCE MINIMALE"
set "QMODE_L_DESC=Tout ce que Souple fait, plus priorit� par jeu et timeout GPU. Chauffe plus."
set "MODE_ACTIVE=MODE ACTIF"
set "PROMPT=Ton choix : "
set "DET_GPU=Carte graphique"
set "DET_RAM=M�moire vive "
...
set "DET_GB=Go"
set "DET_KB=Ko"
set "Q_INTRO=R�ponds aux questions ci-dessous (une touche; tape 0 pour revenir) :"
set "QH_CAM=CAM�RA"
set "QH_WIFI=CARTES R�SEAU (WI-FI / ETHERNET)"
set "QH_BT=BLUETOOTH"
set "QH_PRINT=IMPRIMANTE"
set "QH_XBOX=XBOX"
set "QH_MIC=MICROPHONE (mode par defaut)"
set "QO_YESNO=!CG![1] Oui!C0!  !CR![2] Non!C0!"
set "CFM_KEEP=inchang�"
set "CFM_OFF=d�sactiv�"
set "CFM_RST=restaur�"
set "QO_CAM=!CL![1] Garder active!C0!  !CR![2] D�sactiver!C0!  !CG![3] Restaurer d�faut!C0!"
...
set "QO_NDR=!CL![1] Ne rien faire!C0!  !CR![2] D�sactiver!C0!  !CG![3] Restaurer d�faut!C0!"
set "QO_NET=!CL![1] Garder!C0!  !CR![2] D�sactiver Wi-Fi!C0!  !CR![3] D�sactiver Ethernet!C0!"
...
set "DONE_APPLY=TERMIN�"
set "SUMMARY_HEAD=R�SUM�"
set "SUM02=Le jeu au premier plan a la !CG!priorit� maximale!C0!."
set "SUM03=CPU totalement !CG!d�park�!C0!, aucun �conomiseur, pas de veille."
set "SUM03L=Parking CPU laiss� par !CG!d�faut!C0!, C-states gard�s (batterie)."
set "M5LAP=!CW!ULPS!C0! gard� ON pour la batterie"
set "LAPDET=Portable d�tect� -> r�glages batterie + thermiques forc�s par-dessus le mode choisi."
set "SUMLAP=R�glages portable : timer sur secteur seulement, ULPS gard�, parking CPU par d�faut, plan Perf �lev�es, dynamic tick on, �co Wi-Fi sur batterie."
set "SUM04=Souris !CG!1:1!C0!, z�ro acc�l�ration Windows."
set "SUM05=R�seau r�gl� pour le minimum de lag."
set "SUM06=Mouchards, t�l�m�trie et services inutiles !CR!coup�s!C0!."
set "SUM07=Blocage pub + t�l�m�trie MS via hosts (!CC!215 domaines!C0! + exclusion Defender)."
set "SUM08=!CW!Widgets, Outlook (nouveau), Task View!C0! !CR!retir�s!C0!."
set "SUM09=Plein �cran exclusif + GPU hautes performances sur les jeux."
set "SUM11=Int�grit� m�moire !CG!gard�e on!C0!, !CW!UAC!C0! ne pr�vient jamais."
set "SUM12=Bureau � distance !CR!off!C0!, indexation !CG!activ�e!C0!."
set "SUM13=Apparence : transparence, accent gris, fond noir, secondes."
set "SUM14=Disques optimis�s par la t�che native + !CW!Assistant de stockage!C0!."
set "SUM15=Nettoyage temp, cache et !CW!Windows.old!C0! effectu�."
set "SUM16=Timer forc� � !CC!0.5 ms!C0! au d�marrage (aucun outil externe)."
set "SUM17=R�glages cl�s r�-appliqu�s apr�s les MAJ ; nettoyage s�r !CG!� chaque session!C0!."
set "SUM18=Infos de saisie, suggestions, spotlight �cran verrouill�, voix en ligne, actions sugg�r�es : OFF"
set "SUM_DEV=P�riph�riques & Xbox (!CW!cam�ra, Wi-Fi, Bluetooth, imprimante!C0!) : selon tes choix."
set "Q_RESTART=Red�marrer le PC maintenant pour tout appliquer ?"
set "RESTARTING=Red�marrage dans 5 secondes..."
set "RESTART_LATER=OK - pense � red�marrer plus tard pour tout appliquer."
set "REST_INTRO=Restauration des valeurs par d�faut Windows..."
set "REST_DONE_HEAD=RESTAURATION TERMIN�E"
set "REST_NOTE1=Valeurs par d�faut Windows restaur�es."
set "REST_NOTE2=Non auto-restaur� : applis debloat�es, OneDrive, �pingles."
set "REST_NOTE3=L'isolation du noyau n'a PAS �t� touch�e par ce script."
set "SIGN_BY=par"
set "SIGN_TAIL=r�alis� avec Claude.ai"
set "BAN_A=Moteur syst�me : CPU, planificateur, GPU, souris, r�seau"
set "BAN_B=Confidentialit�, t�l�m�trie et mode jeu"
set "BAN_C=P�riph�riques & Xbox (selon tes choix)"
set "BAN_D=Applis, apparence et interface"
set "BAN_E=Alimentation et d�marrage"
set "BAN_F=Disques et maintenance"
set "BAN_G=Mises � jour"
set "BAN_H=Latence temps r�el"
set "BACK=Retour"
:_strdone
rem ============ MENU AIO ============
...
if /i "!L!"=="FR" set "AO3=Timer 0.5 ms + tweak NVIDIA (ancienne m�thode de sharpening)"
...
if /i "!L!"=="FR" set "AO7=Restaurer la protection temps r�el Defender"
if /i "!L!"=="FR" set "AO8=Outil de v�rification / debug"
...
if /i "!L!"=="FR" set "MCAT2=r�glages ind�pendants"
if /i "!L!"=="FR" set "MCAT3=syst�me"
...
if /i "!L!"=="FR" set "CL7B=Telechargements gard� (script lanc� depuis ce dossier)"
