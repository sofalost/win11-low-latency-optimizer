...
set "M9A_AI_KEPT=IA / Copilot / Recall gard{e9}s ON - virtualisation ou IA requise"
set "M9A_AI_OFF=IA / Copilot / Recall coup{e9}s OFF - ni virtualisation ni IA"
...
set "QH_XBOX=XBOX"
set "QH_MIC=MICROPHONE (mode par d{e9}faut)"
...
set "QO_MIC_NAME=Entre le nom exact du micro (sensible {e0} la casse) :"
set "QO_MIC_LIST=--- Microphones detectes ---"
set "QO_MIC_NONE=Aucun microphone trouv{e9}."
set "QO_MIC_SET=Micro par d{e9}faut d{e9}fini :"
set "QO_MIC_KEPT=Micro laiss{e9} inchang{e9}."
