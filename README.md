...
**Standalone tweaks**
- **[3]** 0.5 ms timer + NVIDIA tweak (restores the old sharpening method)
...
This is a *curated* set, not a magic FPS button. The documentation flags which tweaks are high-impact, which are situational and which are essentially placebo, so you can decide what to keep.
