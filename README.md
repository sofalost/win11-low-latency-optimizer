...
- **Per-game priority** — IFEO high priority for CS2, LoL, Brawlhalla, R6 Siege, Valorant, Apex, Fortnite, Warframe, Roblox, Deadlock, Marvel Rivals, Overwatch 2, Bodycam, Ready or Not, Rocket League, REMATCH, Team Fortress 2 (keyed by executable name: works whatever the launcher — Steam, Epic, Riot, Battle.net, Xbox, EA, Ubisoft, GOG)
