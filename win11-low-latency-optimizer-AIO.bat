@echo off
chcp 1252 >nul
title win11-low-latency-optimizer  -  AIO
...
set "TN_CH=       [1] Apply       [2] Remove       [0] Skip"
...
if /i "!L!"=="FR" set "TN_CH=       [1] Appliquer       [2] Retirer       [0] Ignorer"
...
echo   !TN_PHAN!
set "PHANCNT=0"
for /f "usebackq delims=" %%n in (`powershell -NoProfile -Command "$ErrorActionPreference='SilentlyContinue'; $k=0; Get-PnpDevice | Where-Object { $_.Status -eq 'Unknown' } | ForEach-Object { pnputil /remove-device $_.InstanceId | Out-Null; $k++ }; Write-Output $k"`) do set "PHANCNT=%%n"
set "PHANSTATE=!PHANCNT! removed"
if /i "!L!"=="FR" set "PHANSTATE=!PHANCNT! retire(s)"
echo   !TN_PHANOK1! !PHANCNT!
goto T_DONE
:T_REMOVE
echo   !TN_TREM!
schtasks /Delete /F /TN "TimerRes 0.5ms" >nul 2>&1
...
echo  ================================================================
echo    !TN_SUM!
echo      !TN_LT!   : !TIMERSTATE!
echo      !TN_LNV!   : !NVSTATE!
echo      !TN_LPH!   : !PHANSTATE!
echo  ================================================================
echo.
echo   !TN_RB1!
echo   !TN_RB2!
